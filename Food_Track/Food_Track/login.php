  ...
  <div class="form">
      ...
      <div class="tab-content">
        <div id="signup">   
          ...
          <button type="submit" class="button button-block"><a href="index.php" style=" color:white;">Get Started</a></button>
        ...
        <div id="login">   
          ...
          <button class="button button-block"><a href="index.php" style="color:white;">Log In</a></button>
